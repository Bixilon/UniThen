...
The app is available on **AltStore (Classic)** or [SideStore](https://docs.sidestore.io/docs/installation/prerequisites), (and add source `https://dl.bixilon.de/altstore/classic.json`). Installation is well documented, not the easiest way and requires a computer once. As I don't have a paid Apple developer account, I am unable to notarize any version. Then AltStore PAL would be possible, which is a lot more convenient.
