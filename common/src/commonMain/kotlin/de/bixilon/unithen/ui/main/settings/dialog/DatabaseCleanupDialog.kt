...
import unithen.common.generated.resources.database_cleanup_success
import unithen.common.generated.resources.database_cleanup_title
import unithen.common.generated.resources.settings_entrypoint_description
...
fun DatabaseCleanupDialog(dismiss: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        try {
            storage.clearCache()
            storage.cleanup()
            toast.invoke(Res.string.database_cleanup_success)
            restart.invoke()
        } finally {
