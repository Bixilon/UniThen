...
enum class MainScreens(
    ...
    COURSES(Icons.Default.DateRange, Res.string.main_navigation_courses, CoursesRoute),
    CHECKIN_PRESENT(Icons.Default.QrCode, Res.string.main_navigation_checkin_present, CheckInPresentRoute),
    CHECKIN_SCAN(Icons.Default.QrCodeScanner, Res.string.main_navigation_checkin_scan, CheckInScanRoute),
    SETTINGS(Icons.Default.Settings, Res.string.main_navigation_settings, SettingsRoute),
    ;
