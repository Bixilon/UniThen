...
fun SettingsScreen() {
    ...
    Screen(Modifier.verticalScroll(scrollState), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        if (tutor) {
            Section(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                SectionTitle(Res.string.settings_scan.i18n())
                BooleanSetting(Settings.SCAN_QR_HIGH_RESOLUTION, Res.string.settings_scan_high_resolution.i18n(), Res.string.settings_scan_high_resolution_description.i18n())
                BooleanSetting(Settings.SCAN_QR_AUTO_SCAN, Res.string.settings_scan_auto_scan.i18n(), Res.string.settings_scan_auto_scan_description.i18n())
                BooleanSetting(Settings.SCAN_AWAIT_SERVER_CONFIRMATION, Res.string.settings_scan_await_server.i18n(), Res.string.settings_scan_await_server_description.i18n())
                BooleanSetting(Settings.SCAN_CONFIRMATION_SCREEN, Res.string.settings_scan_confirmation_screen.i18n(), Res.string.settings_scan_confirmation_screen_description.i18n())
                BooleanSetting(Settings.SCAN_ALLOW_OFFLINE, Res.string.settings_scan_offline.i18n(), Res.string.settings_scan_offline_description.i18n())
            }
            HorizontalDivider()
        }
        ...
        SettingsLink(Res.string.settings_about.i18n(), Icons.Default.Info, AboutRoute)
    }
}
